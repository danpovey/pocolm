...
discount-counts-backward 0.8 0.7 0.6 merged.2gram float.2gram float_derivs.2gram 1gram derivs.1gram derivs_merged.2gram


perl -e "print $prob + $(perturb-counts 2 merged.2gram derivs_merged.2gram perturbed_merged.2gram) . \"\n\"; "
# -10.00412881

discount-counts 0.8 0.7 0.6 perturbed_merged.2gram float.2gram 1gram
discount-counts-1gram 20 <1gram >float.1gram
merge-float-counts float.2gram float.1gram > float.all
